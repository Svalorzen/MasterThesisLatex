...
We call our POMCP variant $\rho$-POMCP. An important fact to note that $\rho$-POMCP is able to deal
...
A second problem is dependent on how returns are approximated \ys{computed or approximated?} in
POMCP. $Q(b,a)$ is computed as the sum of two different factors: the immediate reward
