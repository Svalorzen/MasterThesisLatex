...
\section{Offline vs Online {YS:Planning}}
...
able to provide some sort of solution. The more time is available, the more refined {YS:accurate} the solution
will be. This is in contrast with offline methods, that need to run to completion or otherwise
nothing is gained.
{YS:there are anytime offline methods too, e.g., point-based methods}
