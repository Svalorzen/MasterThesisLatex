...
In order to avoid the computational cost of offline methods, a new venue of approach was invented \ys{new venue of approach was invented? }
...
offline \ys{online - typo?} techniques, and because one of our goals was to scale to real-world scenarios, which are
