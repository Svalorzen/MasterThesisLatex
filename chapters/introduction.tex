...
to maximize the information gathered. \ys{in future}
...
\ref{ref:solutions}.
In particular, our approach is based on online planning \ys{cite}. This type of approach is based on 
...
\ys{I think you should put a paragraph discussing the organization of thesis at the end of introduction. In the above two paragraph, it appears that you are mixing the motivation for online planning and organization. It does not seem coherent. I think you should motivate online planning here on the idea that as the size of the system increases, it is difficult to use offline methods ... we use MCTS because of better performance ... and so on and the organization comes in a separate para. }
...
\ys{I think the final three paragraphs which are summarizing your contributions are bit mixed up. I think you should start by saying that you solve the surveillance problem (hopefully you introduce the surveillance problem somewhere in introduction) using online planning. You use MCTS to solve the problem. You propose a new variant of MCTS, suitable for belief-dependent rewards leading to better estimates/performance. Finally we illustrate empirical success of our method.}
