...
%     \item[Estimate based rewards:] We modify the POMCP algorithm in order to backup reward
%         estimations. Normally sample rewards are progressively averaged into a final estimate, which
%         only requires backup of the rewards obtained during a sample trajectory. In
...
%         This requires a different backup procedure.
